...
class VideoEnhancer:
    ...
    def create_widgets(self):
        ...
        self.brightness_slider.set(0.5)
        ...
        self.saturation_slider.set(0.5)
    ...
    def preview_video_original(self):
        ...
        try:
            ...
            if frame is not None:
                ...
                # Set the fixed position for the window
                x_offset = 1834  # Adjust the x-coordinate as desired
                y_offset = 438   # Adjust the y-coordinate as desired
                self.preview_window_original.geometry(f"640x320+{x_offset}+{y_offset}")
    ...
    def preview_video_modified(self):
        ...
        try:
            ...
            if frame is not None:
                ...
                # Set the fixed position for the window
                x_offset = 1837  # Adjust the x-coordinate as desired
                y_offset = 35    # Adjust the y-coordinate as desired
                self.preview_window_modified.geometry(f"640x320+{x_offset}+{y_offset}")
    ...
    def update_preview_modified(self, event):
        if self.preview_window_modified is not None:
